...
%
% (used with permission by Tim Pearce - Durham University - 2010)
...
%    asynchronous formats can start and end any track at any time during 
%    the score.
...
elseif (type==224); len=2;      %PITCHBEND
else
